...
/*** Database creation script vor voresource 1.1. 02/10/2016
...
GO
/****** Object:  Table [dbo].[Harvester]    Script Date: 2/10/2016 1:39:40 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[Harvester] ([ServiceURL], [RegistryID], [DoHarvest]) VALUES (N'http://irsa.ipac.caltech.edu/cgi-bin/Registry/oai.pl', N'ivo://irsa.ipac/registry', 0)
GO
