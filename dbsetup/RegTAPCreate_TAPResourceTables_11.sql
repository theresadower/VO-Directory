...
CREATE TABLE [rr].[alt_identifier](
	[ivoid] [varchar](512) NOT NULL,
	[alt_identifier] [varchar](1024) NOT NULL
) ON [PRIMARY] 
GO
...
CREATE TABLE [rr].[interface](
    ...
    [mirror_url] [varchar](1024) NULL,
    [security_method_id] [varchar] (1024) NULL
) ON [PRIMARY]
